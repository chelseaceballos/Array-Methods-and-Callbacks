...
function getWinners(data, getFinalsCB) {
    ...
    return winners;
    // return getFinalsCB(data).map(item => item['Home Team Goals'] > ['Away Team Goals'] ? item['Home Team Name'] : item['Away Team Name']);
}
...
function getAverageGoals(getFinalsCB) {
   return getYearsCB(fifaData).reduce((data, goals), 0);
}
